...
module_rules = ['bcl2fastq', 'fastqc', 'multiqc', 'count_reads', 'cellranger_arc']
...
# Set targets list
targets = [x for rule in [bcl2fastq, fastqc, multiqc, count_reads, cellranger_arc] for x in rule]
# --------------------------------------------------
